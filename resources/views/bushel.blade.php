        ...
        <div class="col-md-9">
            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active" data-toggle="tab" role="presentation">
                        <a href="#10week" aria-controls="10week" role="tab" data-toggle="tab">10 Week</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="10week" role="tabpanel">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>1 qt sweet cherries</li>
                                            <li>2 heads green leaf lettuce</li>
                                            <li>1 pint tomatoes</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>4 qt green beans</li>
                                            <li>1 oregano plant</li>
                                            <li>6 green sweets</li>
                                            <li>1 bunches of kale</li>
                                            <li>6 zucchini</li>
                                            <li>4 summer squash</li>
                                            <li>2 cucumbers</li>
                                            <li>1 qt cherry tomatoes</li>
                                            <li>2 onions</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>3 dozen sweet corn</li>
                                            <li>3 onions</li>
                                            <li>3 green sweet peppers</li>
                                            <li>4 cucumbers</li>
                                            <li>1 pt blueberries<li>
                                            <li>2 pt cherry tomatoes</li>
                                            <li>4 green leaf lettuce</li>
                                            <li>6 hungarian hot peppers</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>10 lbs white potatoes</li>
                                            <li>3 leeks</li>
                                            <li>1 qt fort wayne tomato</li>
                                            <li>2 pt heirloom mix</li>
                                            <li>4 green sweet peppers</li>
                                            <li>1 crate white corn</li>
                                            <li>1 dozen bi-color corn</li>
                                            <li>4 cucumbers</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>3 red onions</li>
                                            <li>2 red cabbage</li>
                                            <li>10 lbs red potatoes</li>
                                            <li>1 dozen red tomatoes</li>
                                            <li>2 red leaf lettuce</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>1 8qt round tomatoes</li>
                                            <li>1 8qt roma tomatoes</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>4 heads cauliflower</li>
                                            <li>1 bag cortland apples</li>
                                            <li>1 bag mac apples</li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 head romain lettuce</li>
                                            <li>1 qt strawberries</li>
                                            <li>3 heads broccoli</li>
                                            <li>1 citonella plant</li>
                                            <li>1 basil plant</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>1 zucchini</li>
                                            <li>1/2 seedless watermelon</li>
                                            <li>1/2 pt sweet cherries</li>
                                            <li>1 head green leaf lettuce</li>
                                            <li>1/2 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 dozen sweet corn</li>
                                            <li>1 onion</li>
                                            <li>1 green sweet pepper</li>
                                            <li>2 cucumbers</li>
                                            <li>1/2 pt blueberries</li>
                                            <li>1 pt cherry tomoatoes</li>
                                            <li>1 green leaf lettuce</li>
                                            <li>2 hungarian hot peppers</li>
                                            <li>1/2 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>4 lbs white potatoes</li>
                                            <li>1 leek</li>
                                            <li>1/2 pt fort wayne tomatoes</li>
                                            <li>1/2 pt heirloom tomatoes</li>
                                            <li>1 green sweet pepper</li>
                                            <li>8 white corn</li>
                                            <li>6 bi-color corn</li>
                                            <li>1 cucumber</li>
                                            <li>1 bunch of kale</li>
                                            <li>1/2 dozen brown eggs</li>
                                        </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 bunch of kale</li>
                                            <li>1 dozen white corn</li>
                                            <li>1 cucumber</li>
                                            <li>4 yellow hot peppers</li>
                                            <li>1 green sweet pepper</li>
                                            <li>1 pt blueberries</li>
                                            <li>1 onion</li>
                                            <li>2 round tomatoes</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>1 broccoli</li>
                                            <li>6 tomatoes</li>
                                            <li>6 hungarian peppers</li>
                                            <li>1 pt yellow pear tomatoes</li>
                                            <li>6 bi-color corn</li>
                                            <li>4 brown eggs</li>
                                        </ul>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 green sweet</li>
                                            <li>1 acorn or buttercup squash</li>
                                            <li>1 pt concord grapes</li>
                                            <li>8 round tomatoes</li>
                                            <li>8 roma tomatoes</li>
                                            <li>1 green tomato</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>3 green apples, 20oz</li>
                                            <li>3 mac apples</li>
                                            <li>1 qt concord grapes</li>
                                            <li>1 spaghetti squash</li>
                                            <li>4 ears sweet corn</li>
                                            <li>1 pt heirloom tomatoes</li>
                                            <li>1 head cauliflower</li>
                                            <li>4 round tomatoes</li>
                                            <li>1/2 dozen brown eggs</li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>2 large hanging baskets</li>
                                            <li>1 flat assorted herbs</li>
                                            <li>1 lettuce bowl</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>2 lettuce bowls</li>
                                            <li>1 large porch planter</li>
                                            <li>2 patio tomato plants</li>
                                            <li>1 box citronella</li>
                                            <li>1/2 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>2 heads green leaf lettuce</li>
                                            <li>2 heads red leaf lettuce</li>
                                            <li>3 lbs rhubarb</li>
                                            <li>1 wave petunia basket</li>
                                            <li>1 flat marigolds</li>
                                            <li>1 box geraniums</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>4 heads romaine lettuce</li>
                                            <li>2 qt strawberries</li>
                                            <li>12 heads broccoli</li>
                                            <li>2 large citronella plants</li>
                                            <li>2 basil plants</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 1/2 flats of strawberries</li>
                                            <li>3 heads broccoli</li>
                                            <li>2 heads cabbage</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>2 bunches of kale</li>
                                            <li>4 heads cauliflower</li>
                                            <li>6 heads of cabbage</li>
                                            <li>8 broccoli crowns</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>2 dozen sweet corn</li>
                                            <li>4 green sweet peppers</li>
                                            <li>18 yellow hot peppers</li>
                                            <li>8 green tomatoes</li>
                                            <li>1 qt beans</li>
                                            <li>3 pt blueberries</li>
                                            <li>2 onions</li>
                                            <li>1 romaine lettuce</li>
                                            <li>3 pt cherry tomatoes</li>
                                            <li>4 cucumbers</li>
                                            <li>1 spring dill</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>10 lbs white potatoes</li>
                                            <li>3 leeks</li>
                                            <li>1 qt fort wayne tomatoes</li>
                                            <li>2 pt heirloom tomatoes</li>
                                            <li>4 green sweet peppers</li>
                                            <li>1 crate white corn</li>
                                            <li>1 dozen bi-color corn</li>
                                            <li>4 cucumbers</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 bunch of kale</li>
                                            <li>3 dozen white corn</li>
                                            <li>3 cucumbers</li>
                                            <li>6 yellow hot peppers</li>
                                            <li>2 green sweet peppers</li>
                                            <li>1 pt blueberries</li>
                                            <li>3 onions</li>
                                            <li>6 round tomatoes</li>
                                            <li>3 leaf lettuce</li>
                                            <li>2 eggplants</li>
                                            <li>1 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>4 spaghetti squash</li>
                                            <li>4 onions</li>
                                            <li>6 broccoli</li>
                                            <li>1 box tomatoes</li>
                                            <li>2 yellow mums</li>
                                            <li>24 hungarian peppers</li>
                                            <li>3 pt yellow pear tomatoes</li>
                                            <li>1 dozen bi-color corn</li>
                                            <li>1 1/2 dozen brown eggs</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 bag green apples, 20oz</li>
                                            <li>1 bag mac apples</li>
                                            <li>4 qt concord grapes</li>
                                            <li>4 spaghetti squash</li>
                                            <li>1 dozen sweet corn</li>
                                            <li>1 qt heirloom tomatoes</li>
                                            <li>1 head cauliflower</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>4 heads cauliflower</li>
                                            <li>2 pumpkins</li>
                                            <li>1/2 dozen gourds</li>
                                            <li>8 apples</li>
                                            <li>1 qt concord grapes</li>
                                            <li>6 red tomatoes</li>
